 ...
 * число на масть — вся «сила облегчения». Облегчаются все три сложности;
 * масть без записи взяла бы обычный случайный сид.
 */
const EASY_ATTEMPTS: Partial<Record<SuitCount, number>> = { 1: 64, 2: 64, 4: 64 }
